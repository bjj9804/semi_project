...
DROP TABLE lookitem CASCADE CONSTRAINTS;
...
DROP TABLE RETURN_BUY CASCADE CONSTRAINTS;
...
FOR EACH ROW
BEGIN
	DELETE FROM COUPON WHERE EMAIL = :OLD.EMAIL;
END;
/
...
FOR EACH ROW
BEGIN
	UPDATE COUPON SET COUPONSTATE = '사용완료' WHERE COUPONNUM = :NEW.COUPONNUM;
END;
/
